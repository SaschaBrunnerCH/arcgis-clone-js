...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../src/itemTypes/webmappingapplication"], factory);
    }
    ...
    describe('Web Mapping Application', function () {
        describe('getDependencies', function () {
            it('returns various ids from named props in generic items', function (done) {
                var m = {
                    item: {
                ...
                return webmappingapplication_1.getDependencies(m)
                    .then(function (r) {
            ...
            it('processes a storymap', function (done) {
                var m = {
                    item: {
            ...
            it('processes a WAB', function (done) {
                var m = {
                    item: {

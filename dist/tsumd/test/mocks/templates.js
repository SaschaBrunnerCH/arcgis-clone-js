...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../test/mocks/agolItems"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var mockItems = require("../../test/mocks/agolItems");
    // -- Exports -------------------------------------------------------------------------------------------------------//
    function getSolution(templates) {
        return {
            templates: templates
        };
    }
    exports.getSolution = getSolution;
    function getItemTemplatePart(type, dependencies, url) {
        ...
        switch (type) {
            ...
            case "Feature Service":
                ...
                templatePart.data = getItemTemplateData(type);
                templatePart.resources = null;
                var layer0 = removeEditFieldsInfoField(getLayerOrTableTemplate(0, "ROW Permits", "Feature Layer", [createItemTemplateRelationship(0, 1, "esriRelRoleOrigin")]));
                templatePart.estimatedDeploymentCostFactor += 2;
                var table1 = removeEditFieldsInfoField(getLayerOrTableTemplate(1, "ROW Permit Comment", "Table", [createItemTemplateRelationship(0, 0, "esriRelRoleDestination")]));
                templatePart.estimatedDeploymentCostFactor += 2;
                var properties = {
            ...
            case "Project Template":
                break;
            case "Web Map":
                templatePart = getItemTemplateFundamentals(type, "map", dependencies, url || "{{organization.portalBaseUrl}}/home/webmap/viewer.html?webmap={{map1234567890.id}}");
                templatePart.data = getItemTemplateData(type);
                templatePart.resources = null;
                templatePart.estimatedDeploymentCostFactor = 4;
                break;
            case "Web Mapping Application":
                templatePart = getItemTemplateFundamentals(type, "wma", dependencies, url || "{{organization.portalBaseUrl}}/apps/CrowdsourcePolling/index.html?appid={{wma1234567890.id}}");
                templatePart.data = getItemTemplateData(type);
                templatePart.resources = null;
                templatePart.estimatedDeploymentCostFactor = 4;
                break;
    ...
    exports.getItemTemplatePart = getItemTemplatePart;
    function getDashboardTemplatePartNoWidgets() {
        var templatePart = getItemTemplatePart("Dashboard");
    ...
    function getTemplatePartNoData(type) {
        var templatePart = getItemTemplatePart(type);
    ...
    function getFeatureServiceTemplatePartNoRelationships() {
        var templatePart = getItemTemplatePart("Feature Service");
    ...
    function getFourItemFeatureServiceTemplatePart() {
        var templatePart = getItemTemplatePart("Feature Service");
        // Update data section
        ...
        var layer2 = removeEditFieldsInfoField(getLayerOrTableTemplate(2, "ROW Permits layer 2", "Feature Layer"));
        var layer3 = removeEditFieldsInfoField(getLayerOrTableTemplate(3, "ROW Permits layer 3", "Feature Layer"));
    ...
    exports.getFourItemFeatureServiceTemplatePart = getFourItemFeatureServiceTemplatePart;
    ...
    function getWebMappingApplicationTemplate() {
        var template = [
            getItemTemplatePart("Web Mapping Application", ["map1234567890"], "{{organization.portalBaseUrl}}/apps/CrowdsourcePolling/index.html?appid={{wma1234567890.id}}"),
            getItemTemplatePart("Web Map", ["svc1234567890"], "{{organization.portalBaseUrl}}/home/webmap/viewer.html?webmap={{map1234567890.id}}"),
    ...
    function getWebMappingApplicationTemplateNoWebmapOrGroup() {
        var template = [
            getItemTemplatePart("Web Mapping Application", null, "{{organization.portalBaseUrl}}/apps/CrowdsourcePolling/index.html?appid={{wma1234567890.id}}"),
        ];
    ...
    function getServiceTemplate(layers, tables) {
    ...
    function getItemTemplateFundamentals(type, typePrefix, dependencies, url) {
        if (dependencies === void 0) { dependencies = []; }
        if (url === void 0) { url = ""; }
        return {

...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@esri/arcgis-rest-auth", "../src/itemTypes/classifier", "../src/itemTypes/common", "../src/itemTypes/featureservice", "../src/itemTypes/group", "../src/utils/item-helpers", "../src/solution", "../src/itemTypes/webmap", "./lib/utils", "./customMatchers", "fetch-mock", "./mocks/agolItems", "./mocks/templates", "./lib/utils"], factory);
    }
    ...
    describe("Module `solution`: generation, publication, and cloning of a solution item", function () {
        ...
        describe("publish solution", function () {
            ...
            it("for single item containing WMA & feature service, but share as public fails", function (done) {
                ...
                mSolution.publishSolution("My Solution", mockSolutions.getWebMappingApplicationTemplate(), MOCK_USER_REQOPTS, null, "public")
                    .then(function () { return done.fail(); }, function (error) {
                    expect(error).toEqual(mockUtils.ArcgisRestSuccessFail);
                    done();
                });
        ...
        describe("clone solution", function () {
            ...
            it("should handle an empty, nameless solution", function (done) {
                ...
                mSolution.deploySolution({}, MOCK_USER_REQOPTS, settings)
                    .then(done, done.fail);
            });
        ...
        describe("supporting routine: deployWhenReady ", function () {

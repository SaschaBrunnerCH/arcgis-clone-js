...
function getFullItem(id, requestOptions) {
    return new Promise(function (resolve, reject) {
        ...
        items.getItem(id, requestOptions)
            ...
            var dataRequest = tslib_1.__assign({}, requestOptions, { file: exports.FILE_BASED_ITEM_TYPES.indexOf(itemResponse.type) > -1 });
            var dataPromise = items.getItemData(id, dataRequest);

 ...
 * of ids
 */
function createSolutionTemplate(ids, requestOptions, templates) {
    if (!templates) {
        templates = [];
    }
    return new Promise(function (resolve, reject) {
        if (typeof ids === "string") {
                    ...
                    if (itemTemplate.dependencies.length === 0) {
                        ...
                        itemTemplate.dependencies.forEach(function (dependentId) {
                            if (!getTemplateInSolution(templates, dependentId)) {
                                dependentDfds_1.push(createSolutionTemplate(dependentId, requestOptions, templates));
                            }
                        });
            ...
            ids.forEach(function (id) {
                getHierarchyPromise_1.push(createSolutionTemplate(id, requestOptions, templates));
            });

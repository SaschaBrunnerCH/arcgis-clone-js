 ...
 */
export function createSolutionStorymap(title, solution, requestOptions, orgUrl, folderId, access) {
 ...
 * @protected
 */
export function createSolutionStorymapItem(title, solution, folderId) {
    if (folderId === void 0) { folderId = null; }
 ...
 * @protected
 */
export function getStorymapItemFundamentals(title) {
 ...
 * @protected
 */
export function publishSolutionStorymapItem(solutionStorymap, requestOptions, orgUrl, folderId, access) {
    if (folderId === void 0) { folderId = null; }
    if (access === void 0) { access = "private"; }
    return new Promise(function (resolve, reject) {

...
export function getAGOLItem(type, url) {
    if (url === void 0) { url = ""; }
...
export function getAGOLItemData(type) {
...
export function getAGOLItemResources(testCase) {
...
export function getAGOLGroupContentsList(numToPutIntoGroup) {
    var group = {
        "total": 0,
        "start": 1,
        "num": 0,
...
export function getAGOLService(layers, tables) {
...
export function getAGOLLayerOrTable(id, name, type, relationships) {
...
export function createAGOLRelationship(id, relatedTableId, role) {
    var relationship = {
        "id": id,
        "name": "",

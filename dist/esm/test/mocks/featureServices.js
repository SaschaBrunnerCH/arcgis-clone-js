 ...
 */
// -- Exports -------------------------------------------------------------------------------------------------------//
export function getService(layers, tables) {
...
export function getLayerOrTable(id, name, type, relationships) {
...
export function getRelationship(id, relatedTableId, role) {
    var relationship = {
        "id": id,
        "name": "",

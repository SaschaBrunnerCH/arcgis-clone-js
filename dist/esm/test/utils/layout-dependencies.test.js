...
import { getLayoutDependencies, getCardDependencies } from '../../src/utils/layout-dependencies';
var testLayout = {
    sections: [
        {
            rows: [
...
describe('Layout Dependencies', function () {
    it('extracts dependencies from a whole layout', function () {
        var r = getLayoutDependencies(cloneObject(testLayout));

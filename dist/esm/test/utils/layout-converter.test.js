...
import { convertLayoutToTemplate, convertSection, convertRow, convertCard, convertFollowCard, convertEventListCard, convertItemGalleryCard, convertImageCard, convertJumbotronCard, extractAssets } from '../../src/utils/layout-converter';
describe('Layout Converter', function () {
    it('should return null if passed null', function () {
        var result = convertLayoutToTemplate(null);
        expect(result).toBeNull();
    });
    it('should convert the layout', function () {
        var result = convertLayoutToTemplate(TestLayout);
    ...
    it('should clone the footer if passed in', function () {
        var layout = cloneObject(TestLayout);
        layout.footer = {
            foo: "bar"
        };
        var result = convertLayoutToTemplate(layout);
    ...
    describe('Card Converters', function () {
        ...
        it('should convert event list card', function () {
            ...
            var result = convertEventListCard(c).card;
        ...
        it('should convert gallery card', function () {
            ...
            var result = convertItemGalleryCard(c).card;
            ...
            var result2 = convertCard(c).card;
        ...
        it('converts an image card', function () {
            ...
            var result = convertImageCard(card);
        ...
        it('converts a jumbotron card', function () {
            ...
            var result = convertJumbotronCard(card);
            expect(result.assets.length).toEqual(2, 'should have two assets');
            expect(result.assets[0]).toEqual(card.component.settings.fileSrc, 'should have fileSrc');
            expect(result.assets[1]).toEqual(card.component.settings.cropSrc, 'should have cropSrc');
            var result2 = convertCard(card);

...
export function doCommonTemplatizations(itemTemplate) {
 ...
 */
export function createItemWithData(item, data, requestOptions, folderId, access) {
 ...
 */
export function createUnavailableItemError(itemId) {
    return new ArcGISRequestError("Item or group does not exist or is inaccessible: " + itemId);
}
export function deTemplatize(id) {
    if (id.startsWith("{{")) {
...
export function deTemplatizeList(ids) {
...
export function templatize(id, param) {
...
export function templatizeList(ids, param) {
    if (param === void 0) { param = "id"; }
    return ids.map(function (id) {
 ...
 */
export function updateItemURL(id, url, requestOptions) {
    return new Promise(function (resolve, reject) {
        // Update its URL

 ...
 * @protected
 */
export function addFeatureServiceLayersAndTables(itemTemplate, settings, requestOptions, progressCallback) {
    return new Promise(function (resolve, reject) {
...
export function countRelationships(layers) {
 ...
 * @protected
 */
export function fleshOutFeatureService(itemTemplate, requestOptions) {
    return new Promise(function (resolve, reject) {
        var properties = {
            service: {},
            layers: [],

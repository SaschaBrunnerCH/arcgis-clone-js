...
export function getEstimatedDeploymentCost(solution) {
 ...
 */
export function deploySolution(solution, requestOptions, settings, progressCallback) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (settings.folderId) {
            ...
            var folderName = (settings.solutionName || "Solution") + " (" + mCommon.getUTCTimestamp() + ")";
            var options = {
                title: folderName,
...
export function deployWhenReady(solution, requestOptions, settings, itemId, progressCallback) {
    settings[itemId] = {};

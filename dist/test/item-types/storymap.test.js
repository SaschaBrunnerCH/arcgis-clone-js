...
describe('Story Maps :: ', function () {
    describe('generic functions', function () {
        describe('getting dependencies', function () {
            it('can get dependencies for a cascade', function () {
                var m = {
                    item: {
                ...
                var r = storymap_1.extractDependencies(m);
            ...
            it('works for Map Journal', function () {
            ...
            it('works for Map Series', function () {
            ...
            it('returns empty array if run on a non-storymap item', function () {
                var m = {
                    item: {
                        typeKeywords: ['other']
                    },

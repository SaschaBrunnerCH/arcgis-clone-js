...
function getAGOLItem(type, url) {
    ...
    switch (type) {
        ...
        case "Code Sample":
            break;
        case "Dashboard":
            item = getAGOLItemFundamentals(type, "dsh", url || "https://arcgis.com/apps/opsdashboard/index.html#/");
            break;
        case "Desktop Add In":
            break;
        ...
        case "Project Template":
            break;
        case "Web Map":
            item = getAGOLItemFundamentals(type, "map", url || "https://arcgis.com/home/webmap/viewer.html?webmap=");
            break;
        case "Web Mapping Application":
            item = getAGOLItemFundamentals(type, "wma", url || "https://arcgis.com/apps/CrowdsourcePolling/index.html?appid=");
            break;
...
function getNoNameFeatureServiceItem() {
    var item = getAGOLItem("Feature Service");
    item.name = null;
    return item;
}
exports.getNoNameFeatureServiceItem = getNoNameFeatureServiceItem;
...
//# sourceMappingURL=itemsXX.js.map